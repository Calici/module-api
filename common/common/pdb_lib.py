...
class PdbRecord(object):
    ...
    def is_remove_item(self) -> bool:
        return self.is_remove_ion or self.residue_name == 'HOH'
    ...
    def is_ion_need_change_residue_name(self) -> bool:
        ...
        """
        return self.is_ion and self.residue_name != self.element

    @property
    def file_name(self) -> bool:
        return f'{self.residue_name}-{self.residue_seq:04d}.pdb'
